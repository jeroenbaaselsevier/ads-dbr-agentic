...
common_outputs:
  ...
  - csv
pitfalls:
  - OA fields (openaccess.flag, openaccess.oatype) are in ANI — no join needed
  - OA type vocabulary: gold, hybrid, green, bronze, closed
review_checks:
  - verify nopp() on ANI
  - verify correct openaccess column names
---
...
ani_stamp        = '20260301'
str_path_project = '/mnt/els/rads-projects/short_term/2026/2026_XXX_oa_analysis'
