...
common_outputs:
  ...
  - csv
pitfalls:
  - Gender is probabilistic — report as distribution, not binary label
  - ADS gender is at author level; link via auid or position
  - left join only
review_checks:
  - verify left join to ADS gender table
  - verify nopp() on ANI
  - verify correct author position handling
---
...
ani_stamp        = '20260301'
str_path_project = '/mnt/els/rads-projects/short_term/2026/2026_XXX_gender_analysis'
