---
name: patents-citation-analysis
triggers:
  - patents
  - patent citation
  - npl
...
required_functions:
  ...
  - patents.join_npl_citations
common_outputs:
  - notebook
  - csv
pitfalls:
  - only ~15% of NPL citations resolve to Scopus EID — left join
  - npl_citations_scopus lags metadata by ~5 months
  - cache large intermediates
review_checks:
  - verify left join to patents npl_citations_scopus
  - verify nopp() on ANI
  - verify join on eid (long)
---
...
ani_stamp        = '20260301'
str_path_project = '/mnt/els/rads-projects/short_term/2026/2026_XXX_patent_citations'
